            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 about-title">
                        ...
                        <button type="button" class="btn button primary-button text-uppercase">Download PDF</button>
                    </div>
                    <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="feedback_form.php" class="php-email-form" role="form" method="POST" >
              <div class="row">
